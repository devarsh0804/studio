...
import { CalendarIcon, Camera, User, Wheat, MapPin, Sparkles, Loader2 } from "lucide-react";
...
interface GradingFormProps {
  onGrade: (lot: GradedLot) => void;
}

export function GradingForm({ onGrade }: GradingFormProps) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center">
            <Sparkles className="mr-2"/> New Grading Session
        </CardTitle>
        <CardDescription>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Button type="submit" size="lg" className="w-full" disabled={isGrading}>
                ...
                {isGrading ? 'Grading Crop...' : 'Grade and Generate Certificate'}
            </Button>
          </form>
        </Form>
      </CardContent>
